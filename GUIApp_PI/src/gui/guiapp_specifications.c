...
/*  Date (dd.mm.yyyy): 21. 1.2019   Time (hh:mm): 08:34                        */
/*******************************************************************************/
...
GX_PROMPT_PROPERTIES window2_duty_properties =
{
    GX_STRING_ID_TEXT_DUTY,                  /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT                /* selected text color            */
};
GX_PROMPT_PROPERTIES window2_text_speed_properties =
{
...
GX_PROMPT_PROPERTIES window2_sw_ver_properties =
{
    GX_STRING_ID_SW_VER,                     /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT                /* selected text color            */
};
GX_PROMPT_PROPERTIES window2_hw_ver_properties =
{
    GX_STRING_ID_HW_VER,                     /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT                /* selected text color            */
};
GX_PROMPT_PROPERTIES window2_hw_data_properties =
{
    GX_STRING_ID_HW_DATA,                    /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT                /* selected text color            */
};
GX_PROMPT_PROPERTIES window2_header_autor_properties =
{
    GX_STRING_ID_HEADER_AUTOR,               /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT                /* selected text color            */
};
GX_PROMPT_PROPERTIES window2_autor1_properties =
{
    GX_STRING_ID_AUTOR1,                     /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT                /* selected text color            */
};
...
GX_CONST GX_STUDIO_WIDGET window2_autor1_define =
{
    "autor1",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_AUTOR1,                               /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {0, 160, 234, 183},                      /* widget size                    */
    &window2_prompt_define,                  /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW2_CONTROL_BLOCK, window2_autor1), /* control block          */
    (void *) &window2_autor1_properties      /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window2_header_autor_define =
{
    "header_autor",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_HEADER_AUTOR,                         /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_NONE|GX_STYLE_TRANSPARENT|GX_STYLE_ENABLED|GX_STYLE_TEXT_LEFT,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {0, 140, 129, 163},                      /* widget size                    */
    &window2_autor1_define,                  /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW2_CONTROL_BLOCK, window2_header_autor), /* control block    */
    (void *) &window2_header_autor_properties /* extended properties           */
};

GX_CONST GX_STUDIO_WIDGET window2_hw_data_define =
{
    "hw_data",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_HW_DATA,                              /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_NONE|GX_STYLE_TRANSPARENT|GX_STYLE_ENABLED|GX_STYLE_TEXT_LEFT,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {0, 120, 234, 143},                      /* widget size                    */
    &window2_header_autor_define,            /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW2_CONTROL_BLOCK, window2_hw_data), /* control block         */
    (void *) &window2_hw_data_properties     /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window2_hw_ver_define =
{
    "hw_ver",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {0, 100, 99, 123},                       /* widget size                    */
    &window2_hw_data_define,                 /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW2_CONTROL_BLOCK, window2_hw_ver), /* control block          */
    (void *) &window2_hw_ver_properties      /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window2_sw_ver_define =
{
    "sw_ver",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_SW_VER,                               /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {0, 80, 99, 103},                        /* widget size                    */
    &window2_hw_ver_define,                  /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW2_CONTROL_BLOCK, window2_sw_ver), /* control block          */
    (void *) &window2_sw_ver_properties      /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window2_text_speed_define =
{
    "text_speed",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_TEXT_SPEED,                           /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_NONE|GX_STYLE_TRANSPARENT|GX_STYLE_ENABLED|GX_STYLE_TEXT_LEFT,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {0, 60, 79, 83},                         /* widget size                    */
    &window2_sw_ver_define,                  /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW2_CONTROL_BLOCK, window2_text_speed), /* control block      */
    (void *) &window2_text_speed_properties  /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window2_duty_define =
{
    "duty",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_TEXT_DUTY,                            /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_NONE|GX_STYLE_TRANSPARENT|GX_STYLE_ENABLED|GX_STYLE_TEXT_LEFT,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {0, 40, 79, 63},                         /* widget size                    */
    &window2_text_speed_define,              /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW2_CONTROL_BLOCK, window2_duty), /* control block            */
    (void *) &window2_duty_properties        /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window2_window2_text_define =
{
    ...
    &window2_duty_define,                    /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
