...
#define ID_TEXT_DUTY 4
#define ID_TEXT_SPEED 5
#define ID_SW_VER 6
#define ID_HW_DATA 7
#define ID_HEADER_AUTOR 8
#define ID_AUTOR1 9
#define ID_WINDOW1 10
#define ID_BUTTONENABLER 11
#define ID_INSTRUCTIONS 12
#define ID_WINDOWCHANGER 13
...
typedef struct WINDOW2_CONTROL_BLOCK_STRUCT
{
    ...
    GX_PROMPT window2_duty;
    GX_PROMPT window2_text_speed;
    GX_PROMPT window2_sw_ver;
    GX_PROMPT window2_hw_ver;
    GX_PROMPT window2_hw_data;
    GX_PROMPT window2_header_autor;
    GX_PROMPT window2_autor1;
